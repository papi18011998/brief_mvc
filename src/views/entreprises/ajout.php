...
<form class="d-flex" method="POST" action="../utilisateurs/entrepriseController">
    <div class="col-6 border-end">
        ...
        <div class="form-row align-items-center">
         <div class="col-sm-3 col-md-12 my-1 px-3">
            ...
            <input type="text" class="form-control" id="nom_entreprise" placeholder="Nom de l'entreprise" name="nom_entreprise">
         </div>
        </div>
        <!-- Regime et doamine -->
        ...
        <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="text" class="form-control" id="ninea" placeholder="Mettez le ninea" name="ninea">
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
            <label class="sr-only" for="rccm">Registre de commerce</label>
            <input type="text" class="form-control" id="rccm" placeholder="Mettez le registre de commerce" name="rccm">
         </div>
        </div>
        ...
        <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="text" class="form-control" id="coordonnees" placeholder="Mettez les coordonnes" name="coordonnees">
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
            <label class="sr-only" for="page_web">Page web</label>
            <input type="text" class="form-control" id="page_web" placeholder="lien de votre page web" name="page_web">
         </div>
        </div>
        ...
        <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="number" class="form-control" id="nombre_emloye" placeholder="Mettez les nombres d'employés" name="nombre_emloye" style="appearance:textfield;">
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
        ...
        <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="text" class="form-control" id="contrat" placeholder="Mettez les contrats des employés" name="contrat" >
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
    ...
    <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="text" class="form-control" id="prenom_repondant" placeholder="Mettez le prenom du repondant" name="prenom_repondant">
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
            <label class="sr-only" for="nom_repondant">Nom du Repondant</label>
            <input type="text" class="form-control" id="nom_repondant" placeholder="Mettez le nom du repondant" name="nom_repondant">
         </div>
    </div>
    ...
    <div class="form-row align-items-center d-flex">
         <div class="col-sm-3 col-md-6 my-1 px-3">
            ...
            <input type="text" class="form-control" id="telephone_repondant" placeholder="Mettez le telephone du repondant" name="telephone_repondant">
         </div>
         <div class="col-sm-3 col-md-6 my-1 px-3">
            <label class="sr-only" for="courriel">Email du Repondant</label>
            <input type="email" class="form-control" id="courriel" placeholder="Mettez l'adresse mail du repondant" name="courriel">
         </div>
    </div>
